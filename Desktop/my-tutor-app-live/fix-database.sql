-- FIXED SQL SCRIPT FOR TUTOR SCHEDULING SYSTEM
...
-- Create availability table (using lesson_date instead of date)
...
-- Create lessons table (using lesson_date instead of date)
