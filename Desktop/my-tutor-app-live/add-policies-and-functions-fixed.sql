-- ADD POLICIES AND FUNCTIONS - FIXED VERSION
-- Run this AFTER clean-database-setup.sql completes successfully
...
-- Simple completion indicator (no RAISE NOTICE to avoid errors)
SELECT 'POLICIES AND FUNCTIONS SETUP COMPLETED SUCCESSFULLY!' as status;
